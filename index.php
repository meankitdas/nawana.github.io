    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://images.pexels.com/photos/546819/pexels-photo-546819.jpeg" class="d-block w-100 rounded" alt="Coding image" style="height: 500px; object-fit: cover;">
            </div>
            <div class="carousel-item">
                <img src="https://images.pexels.com/photos/1591060/pexels-photo-1591060.jpeg" class="d-block w-100 rounded" alt="Technology image" style="height: 500px; object-fit: cover;">
            </div>
            <div class="carousel-item">
                <img src="https://images.pexels.com/photos/577585/pexels-photo-577585.jpeg" class="d-block w-100 rounded" alt="Computer image" style="height: 500px; object-fit: cover;">
            </div>
        </div>
            ...
            echo '
                <div class="col-md-3 my-2">
                    <div class="card" style="width: 18rem;border-radius: 4rem;">
                        <img src="https://images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg" class="card-img-top" alt="Category image" id="img" style="height: 200px; object-fit: cover;">
                        <div class="card-body">
