...
?>
        ...
        <img src="https://images.pexels.com/photos/771742/pexels-photo-771742.jpeg" width="34px" class="mr-3 my-2" alt="User profile">
        <div class="media-body my-2">
            <h5 class="mt-0"><a href="tread.php?treadid=' . $id.'">' .$title.'</a></h5>
            <a class="text-dark" href="tread.php?treadid=' . $id.'">' . substr($desc,0,70).'...</a>
        </div>
        </div>';
        }
        if($noresult){
